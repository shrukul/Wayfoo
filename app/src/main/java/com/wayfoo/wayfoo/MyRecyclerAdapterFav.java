...
import com.wayfoo.wayfoo.CustomTypeFace;
 ...
 */
public class MyRecyclerAdapterFav extends
        RecyclerView.Adapter<MyRecyclerAdapterFav.CustomViewHolder> {
    ...
    public MyRecyclerAdapterFav(Context context, List<FeedItem> feedItemList, List<String> fav) {
        MyRecyclerAdapterFav.feedItemList = feedItemList;
