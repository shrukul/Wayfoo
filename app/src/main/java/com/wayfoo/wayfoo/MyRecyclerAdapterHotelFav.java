...
public class MyRecyclerAdapterHotelFav extends
        RecyclerView.Adapter<MyRecyclerAdapterHotelFav.CustomViewHolder> {
    ...
    public MyRecyclerAdapterHotelFav(Context context, List<FeedItemHotel> feedItemList, MyApplication app, String Hotel, List<String> fav) {
